export const randomQuotes: RandomQuoteArrayType = [
    ...
    { author: `Erin Hanson`, text: `There is freedom waiting for you, on the breezes of the sky, and you ask "What if I fall?" Oh but my darling, What if you fly?` },
    ...
    { author: `Laurie Halse Anderson`, text: `Art without emotion its like chocolate cake without sugar. It makes you gag.` },
    ...
    { author: `Robert Hughes`, text: `The greater the artist, the greater the doubt. Perfect confidence is granted to the less talented as a consolation prize.` },
    ...
    { author: `T. S. Eliot`, text: `Only those who will risk going too far can possibly find out how far one can go.` },
    { author: `Timothy Leary`, text: `...as a guide and protection. Trust your divinity, trust your brain.` },
    { author: `Timothy Leary`, text: `If you want to change the way people respond to you, change the way you respond to people.` },
    ...
    { author: `Tupac Shakur`, text: `Death is not the greatest loss in life. The greatest loss is what dies inside while still alive. Never surrender.` },
    { author: `Tupac Shakur`, text: `If you let a person talk long enough, you'll hear their true intentions.` },
    ...
    { author: `Tupac Shakur`, text: `They got money for wars, but can't feed the poor.` },
    { author: `Victor Hugo`, text: `Music expresses that which cannot be put into words and that which cannot remain silent.` },
    { author: `Vincent van Gogh`, text: `Art is to console those who are broken by life.` },
]
