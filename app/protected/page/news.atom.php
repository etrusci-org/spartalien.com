...
<feed xmlns="http://www.w3.org/2005/Atom">
    ...
    foreach ($news as $v) {
        ...
        printf('<entry><title>NEWS FROM %3$s</title><link href="%2$s%1$s"/><id>tag:spartalien.com,%3$s:news-%1$s</id><updated>%3$sT00:00:00Z</updated><author><name>SPARTALIEN</name></author><content>%4$s</content></entry>',
            $v['id'],
            sprintf('%1$s%2$s', $this->conf['baseURL'], $this->routeURL('news/id:')),
            $v['postedOn'],
