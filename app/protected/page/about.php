...
<div class="box">
    ...
    <span class="btn nobr">Discord: spartalien</span>
    <a class="btn" href="<?php print($this->conf['elsewhere']['discord'][1]); ?>"><?php print($this->conf['elsewhere']['discord'][0]); ?> Server</a>
</div>

<div class="box">
    <h2>DIGITAL + PHYSICAL PURCHASES</h2>
    <p>
        If you decide to buy some of my music or merchandise (thank you!), consider doing so on <a href="<?php print($this->conf['elsewhere']['bandcamp'][1]); ?>">Bandcamp</a>,
