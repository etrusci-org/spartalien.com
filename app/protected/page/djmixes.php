...
$CF = new CloudcastFetcher(user: 'lowtechman', pagingDelay: 500_000);
$CF->fetchAll();
?>
...
<div class="box">
    <h2>DJ Mixes</h2>
    <p>
        I like djing. It's fun.
        <a href="<?php print($this->conf['elsewhere']['mixcloud'][1]); ?>">Follow me on Mixcloud</a> to get notified when I upload a new mix.
    </p>
</div>
