...
<div class="box">
    ...
    <p>
        ...
        Shipping from Switzerland. Usually 1-3 days after you've placed your order.
    </p>
    <p>
        <strong>Return Policy</strong>:
        Please let me know if anything is wrong with the package and we'll figure out a solution together. You can find ways to contact me on the <a href="./about">about page</a>.
    </p>
</div>
