...
<div class="box">
    ...
    <pre>{nocache}<?php $w=32; print(wordwrap(base64_encode($this->_json_enc($this->Router->route, flags: JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE)), width: $w, cut_long_words: true)); ?>{/nocache}</pre>
</div>
